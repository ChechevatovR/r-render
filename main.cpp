...
int main(int argc, char *argv[]) {
    ...
    //render("C:/output_cos.tga", COS_MODE);
    //render("C:/output_depth.tga", DEPTH_MODE);
    //render("C:/output_light.tga", LIGHT_MODE);
    //render("C:/output_norm.tga", NORM_MODE);
    //render("C:/output_refl.tga", REFL_MODE);
    return 0;
}
